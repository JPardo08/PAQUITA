...
if a == 1:
    ann = './E1/preprocessed/relations_training.txt' # Archivo a abrir
if a == 2: 
    ann = './E1/preprocessed/relations_dev.txt' # Archivo a abrir
if a == 3: 
    ann = './E1/preprocessed/relations_test.txt' # Archivo a abrir

train_file='./E1/preprocessed/relations_training.spacy'
dev_file='./E1/preprocessed/relations_dev.spacy'
test_file='./E1/preprocessed/relations_test.spacy'
