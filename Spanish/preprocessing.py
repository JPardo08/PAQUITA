...
# PREPROCESSING CHALLENGE - SPANISH
"""
...
path = "./Spanish/data/testlink/training/TESTLINK_ES_training_data_V2/TESTLINK_training_data/training.txt"
path_token = "./Spanish/data/testlink/training/TESTLINK_ES_training_data_V2/training_tokenized"
...
path_procesado='./Spanish/preprocessed'
...
#     print(als[i])
print('\n'*15)
print('SPANISH - PREPROCESSING READY')