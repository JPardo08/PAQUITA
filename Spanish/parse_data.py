...
if a == 1:
    ann = './Spanish/preprocessed/relations_training.txt' # Archivo a abrir
if a == 2: 
    ann = './Spanish/preprocessed/relations_dev.txt' # Archivo a abrir
if a == 3: 
    ann = './Spanish/preprocessed/relations_test.txt' # Archivo a abrir

train_file='./Spanish/preprocessed/relations_training.spacy'
dev_file='./Spanish/preprocessed/relations_dev.spacy'
test_file='./Spanish/preprocessed/relations_test.spacy'
