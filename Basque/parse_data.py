...
nlp = spacy.blank("fr") # There is no a specific pretrained basque pipeline
...
a = int(input('CHOOSE AN OPTION (1.train /2.dev /3.test): '))

if a == 1:
    ann = './Basque/preprocessed/relations_training.txt' # Archivo a abrir
if a == 2: 
    ann = './Basque/preprocessed/relations_dev.txt' # Archivo a abrir
if a == 3: 
    ann = './Basque/preprocessed/relations_test.txt' # Archivo a abrir

train_file='./Basque/preprocessed/relations_training.spacy'
dev_file='./Basque/preprocessed/relations_dev.spacy'
test_file='./Basque/preprocessed/relations_test.spacy'
