...
if a == 1:
    ann = './Italian/preprocessed/relations_training.txt' # Archivo a abrir
if a == 2: 
    ann = './Italian/preprocessed/relations_dev.txt' # Archivo a abrir
if a == 3: 
    ann = './Italian/preprocessed/relations_test.txt' # Archivo a abrir

train_file='./Italian/preprocessed/relations_training.spacy'
dev_file='./Italian/preprocessed/relations_dev.spacy'
test_file='./Italian/preprocessed/relations_test.spacy'
