...
path = "./Italian/data/clinkart/training/Clinkart_training_data_V2/training.txt"
path_token = "./Italian/data/clinkart/training/Clinkart_training_data_V2/training_tokenized"
...
path_procesado='./Italian/preprocessed'
...
#     print(als[i])
print('\n'*15)
print('ITALIAN - PREPROCESSING READY')